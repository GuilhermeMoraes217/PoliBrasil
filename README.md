...
A arena compacta do `Word Bomb` adapta seu conteúdo ao estado da partida: o lobby usa uma lista enxuta de participantes e não exibe bomba nem cronômetro; a rodada ativa afasta os jogadores do centro; o encerramento mostra um painel final com placar. A seta segmentada fica atrás da bomba e dos cards. O navegador sintetiza efeitos distintos para acerto, erro, explosão por timeout e vitória.
