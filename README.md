...
A arena compacta do `Word Bomb` adapta seu conteúdo ao estado da partida: lobby, rodada ativa ou painel final com placar. A seta segmentada fica atrás da bomba e dos cards. O navegador sintetiza efeitos distintos para acerto, erro, explosão por timeout e vitória.
